...
JNIEXPORT void Java_im_actor_sdk_util_Utilities_aesIgeEncryption(JNIEnv *env, jclass class, jobject buffer, jbyteArray key, jbyteArray iv, jboolean encrypt, int offset, int length) {
...
JNIEXPORT jstring Java_im_actor_sdk_util_Utilities_readlink(JNIEnv *env, jclass class, jstring path) {

...
public class CameraSession {
    ...
    public CameraSession(CameraInfo info, Size preview, Size picture, int format) {
        ...
        SharedPreferences sharedPreferences = AndroidContext.getContext().getSharedPreferences("camera", Activity.MODE_PRIVATE);
        ...
        orientationEventListener = new OrientationEventListener(AndroidContext.getContext()) {
            @Override
            public void onOrientationChanged(int orientation) {
                if (orientationEventListener == null || !initied) {
                    return;
                }
                WindowManager mgr = (WindowManager) AndroidContext.getContext().getSystemService(Context.WINDOW_SERVICE);

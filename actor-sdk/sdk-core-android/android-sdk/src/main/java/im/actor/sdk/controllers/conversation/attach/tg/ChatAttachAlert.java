...
// */
//
//package im.actor.sdk.controllers.conversation.attach.tg;
//
...
//import im.actor.sdk.camera.CameraController;
...
//
//import im.actor.sdk.view.tg.LinearLayoutManager;
//import im.actor.sdk.view.tg.RecyclerListView;
//import im.actor.sdk.view.tg.RecyclerView;
//import im.actor.sdk.view.tg.cells.ShadowSectionCell;
//
...
//            super.onMeasure(MeasureSpec.makeMeasureSpec(Screen.dp(85), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(Screen.dp(90), MeasureSpec.EXACTLY));
//        }
//
...
//            //imageView.setRoundRadius(Screen.dp(27));
//           // addView(imageView, LayoutHelper.createFrame(54, 54, Gravity.TOP | Gravity.CENTER_HORIZONTAL, 0, 7, 0, 0));
//
//            nameTextView = new TextView(context);
//            nameTextView.setTextColor(0xff757575);
...
//        @Override
//        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
//            super.onMeasure(MeasureSpec.makeMeasureSpec(Screen.dp(85), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(Screen.dp(100), MeasureSpec.EXACTLY));
//        }
//
...
//            builder.setMessage("Excluir Anexos");
...
//            nameTextView.setText(user.getName().get());
...
//                    height -= Screen.getStatusBarHeight();
//                }
//                int contentSize = backgroundPaddingTop + Screen.dp(294);
//                int padding = contentSize == Screen.dp(294) ? 0 : Math.max(0, (height - Screen.dp(294)));
...
//            @Override
//            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
//                super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(Screen.dp(294), MeasureSpec.EXACTLY));
//            }
//
//            @Override
//            protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
...
//                lineView.layout(0, Screen.dp(96), width, Screen.dp(96) + lineView.getMeasuredHeight());
//                hintTextView.layout(width - hintTextView.getMeasuredWidth() - Screen.dp(5), height - hintTextView.getMeasuredHeight() - Screen.dp(5), width - Screen.dp(5), height - Screen.dp(5));
//
//                int diff = (width - Screen.dp(85 * 4 + 20)) / 3;
//                for (int a = 0; a < 8; a++) {
//                    int y = Screen.dp(105 + 95 * (a / 4));
//                    int x = Screen.dp(10) + (a % 4) * (Screen.dp(85) + diff);
...
//        attachPhotoRecyclerView.setPadding(Screen.dp(8), 0, Screen.dp(8), 0);
...
//                    AndroidUtils.hideKeyboard(baseFragment.getFragmentView().findFocus());
//                } else {
//                    openCamera();
//                }
//            }
...
//                sendPhotosButton.imageView.setPadding(0, Screen.dp(4), 0, 0);
//            }
...
//        hintTextView.setPadding(Screen.dp(10), 0, Screen.dp(10), 0);
...
//        hintTextView.setCompoundDrawablePadding(Screen.dp(8));
...
//            recordTime.setTypeface(AndroidUtils.getTypeface("fonts/rmedium.ttf"));
//            recordTime.setAlpha(0.0f);
//            recordTime.setTextColor(0xffffffff);
//            recordTime.setPadding(Screen.dp(10), Screen.dp(5), Screen.dp(10), Screen.dp(5));
...
//                    if (getMeasuredWidth() == Screen.dp(100)) {
//                        cx = cx2 = getMeasuredWidth() / 2;
//                        cy2 = cy + cy / 2 + Screen.dp(17);
//                        cy = cy / 2 - Screen.dp(17);
//                    } else {
//                        cx2 = cx + cx / 2 + Screen.dp(17);
//                        cx = cx / 2 - Screen.dp(17);
...
//                    cameraFile = AndroidUtils.generateVideoPath();
...
//                            AndroidUtils.runOnUIThread(videoRecordRunnable, 1000);
//                        }
//                    };
//                    AndroidUtils.lockOrientation(parentFragment.getParentActivity());
...
//                                        return;
//                                    }
//                                    AndroidUtils.addMediaToGallery(cameraFile.getAbsolutePath());
...
//                        return;
//                    }
//                    cameraFile = AndroidUtils.generatePicturePath();
...
//                                ObjectAnimator.ofFloat(currentImage, "translationY", 0, Screen.dp(48)),
//                                ObjectAnimator.ofFloat(nextImage, "translationY", -Screen.dp(48), 0),
...
//                    if (Math.abs(dy) > AndroidUtils.getPixelsInCM(0.4f, false)) {
...
//        recordTime.setAlpha(0.0f);
//        AndroidUtils.cancelRunOnUIThread(videoRecordRunnable);
//        videoRecordRunnable = null;
//        AndroidUtils.unlockOrientation(baseFragment.getParentActivity());
//    }
//
...
//            if (isPortrait) {
//                cameraPanel.measure(View.MeasureSpec.makeMeasureSpec(width, View.MeasureSpec.EXACTLY), View.MeasureSpec.makeMeasureSpec(Screen.dp(100), View.MeasureSpec.EXACTLY));
//            } else {
//                cameraPanel.measure(View.MeasureSpec.makeMeasureSpec(Screen.dp(100), View.MeasureSpec.EXACTLY), View.MeasureSpec.makeMeasureSpec(height, View.MeasureSpec.EXACTLY));
//            }
//            return true;
//        }
//        return false;
...
//        if (view == cameraPanel) {
//            if (isPortrait) {
//                cameraPanel.layout(0, bottom - Screen.dp(100), width, bottom);
//            } else {
//                cameraPanel.layout(right - Screen.dp(100), 0, right, height);
//            }
//            return true;
//        } else if (view == flashModeButton[0] || view == flashModeButton[1]) {
//            int topAdd = Build.VERSION.SDK_INT >= 21 ? Screen.dp(10) : 0;
//            int leftAdd = Build.VERSION.SDK_INT >= 21 ? Screen.dp(8) : 0;
//            if (isPortrait) {
...
//            AndroidUtils.cancelRunOnUIThread(hideHintRunnable);
...
//        animateCameraValues[1] = Screen.dp(80) - cameraViewOffsetX;
//        animateCameraValues[2] = Screen.dp(80) - cameraViewOffsetY;
...
//        boolean isPortrait = AndroidUtils.displaySize.x < AndroidUtils.displaySize.y;
//        float endWidth;
//        float endHeight;
//        if (isPortrait) {
//            endWidth = container.getWidth();
//            endHeight = container.getHeight()/* - Screen.dp(100)*/;
//        } else {
//            endWidth = container.getWidth()/* - Screen.dp(100)*/;
...
//                    if (cameraViewOffsetX >= Screen.dp(80)) {
//                        cameraViewOffsetX = 0;
//                        cameraViewLocation[0] = Screen.dp(-100);
...
//                    cameraViewOffsetX = 0;
//                }
//                if (Build.VERSION.SDK_INT >= 21 && cameraViewLocation[1] < AndroidUtils.statusBarHeight) {
//                    cameraViewOffsetY = AndroidUtils.statusBarHeight - cameraViewLocation[1];
//                    if (cameraViewOffsetY >= Screen.dp(80)) {
//                        cameraViewOffsetY = 0;
//                        cameraViewLocation[0] = Screen.dp(-100);
//                        cameraViewLocation[1] = 0;
//                    } else {
...
//            cameraIcon.setTranslationX(cameraViewLocation[0]);
//            cameraIcon.setTranslationY(cameraViewLocation[1]);
//            int finalWidth = Screen.dp(80) - cameraViewOffsetX;
//            int finalHeight = Screen.dp(80) - cameraViewOffsetY;
//
...
//                }
//                currentHintAnimation = null;
//                AndroidUtils.runOnUIThread(hideHintRunnable = new Runnable() {
//                    @Override
//                    public void run() {
...
//        } else {
//            sendPhotosButton.imageView.setPadding(Screen.dp(2), 0, 0, 0);
...
//                        @Override
//                        protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
//                            int diff = (right - left - Screen.dp(85 * 4 + 20)) / 3;
//                            for (int a = 0; a < 4; a++) {
//                                int x = Screen.dp(10) + (a % 4) * (Screen.dp(85) + diff);
...
//                    }
//                    view = frameLayout;
//                    frameLayout.setLayoutParams(new RecyclerView.LayoutParams(LayoutHelper.MATCH_PARENT, Screen.dp(100)));
//                    break;
//            }
...
//        if (!value || value && Build.VERSION.SDK_INT >= 18 && !AndroidUtils.isTablet()) {
...
//            float top;
//            if (Build.VERSION.SDK_INT <= 19) {
//                top = AndroidUtils.displaySize.y - containerView.getMeasuredHeight() - AndroidUtils.statusBarHeight;
//            } else {
...
//            if (Build.VERSION.SDK_INT <= 19) {
//                revealY -= AndroidUtils.statusBarHeight;
//            }
//        } else {
//            revealX = AndroidUtils.displaySize.x / 2 + backgroundPaddingLeft;
//            revealY = (int) (AndroidUtils.displaySize.y - containerView.getY());
//        }
//
//        int corners[][] = new int[][]{
//                {0, 0},
...
//                {containerView.getMeasuredWidth(), Screen.dp(304)}
//        };
...
//                views[a].setPivotX(views[a].getMeasuredWidth() / 2 + vecX * Screen.dp(20));
//                views[a].setPivotY(views[a].getMeasuredHeight() / 2 + vecY * Screen.dp(20));
//                innerAnimator.startRadius = dist - Screen.dp(27 * 3);
//

...
package im.actor.sdk.view.tg.helper;
...
import im.actor.sdk.view.tg.RecyclerView.OnItemTouchListener;
import im.actor.sdk.view.tg.RecyclerView.ViewHolder;

import java.util.ArrayList;
import java.util.List;

import static im.actor.sdk.view.tg.RecyclerView.*;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (mRecyclerView != null) {
            ...
            mSwipeEscapeVelocity = Screen.dp(120);
            mMaxSwipeVelocity = Screen.dp(800);
            setupCallbacks();
        }
    }
    ...
    public abstract static class Callback {
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (mCachedMaxScrollSpeed == -1) {
                mCachedMaxScrollSpeed = Screen.dp(20);
            }

...
import im.actor.sdk.view.tg.RecyclerView.LayoutParams;
import im.actor.sdk.view.tg.helper.ItemTouchHelper;

import java.util.List;

import static im.actor.sdk.view.tg.RecyclerView.NO_POSITION;
...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements
    ...
    * */
    ...
    static class LayoutState {
        ...
        void log() {
            Log.d("LinearLayoutManager", "avail:" + mAvailable + ", ind:" + mCurrentPosition + ", dir:" +
